...
Operator operators[] = {
    ...
    {Tok_StrConcat, 1, 0, op_cnct, tc_str},
    {Tok_Plus,      2, 0, op_add,  tc_num},
    {Tok_Minus,     2, 0, op_sub,  tc_num},
    {Tok_Multiply,  3, 0, op_mul,  tc_num},
    {Tok_Divide,    3, 0, op_div,  tc_num},
    {Tok_Modulus,   3, 0, op_mod,  tc_num},
    {Tok_Exponent,  4, 1, op_pow,  tc_num}
};
