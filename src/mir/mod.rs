...
pub enum Instruction {
    ...
    AddInt(Value, Value),
    OverflowingAddInt(Value, Value),
    AddFloat(Value, Value),
    SubInt(Value, Value),
    OverflowingSubInt(Value, Value),
    SubFloat(Value, Value),
    MulInt(Value, Value),
    OverflowingMulInt(Value, Value),
