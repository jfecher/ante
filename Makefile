...
LLVMFLAGS := `llvm-config --cppflags --libs Core mcjit interpreter native BitWriter Passes Target --ldflags --system-libs`
...
CPPFLAGS  := -g -O3 -std=c++11 -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS $(WARNINGS)
